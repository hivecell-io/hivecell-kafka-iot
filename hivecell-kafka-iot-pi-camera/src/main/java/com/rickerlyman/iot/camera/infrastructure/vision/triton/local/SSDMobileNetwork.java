...
//
//public class SSDMobileNetwork implements Detection<ObjectDetectionResult> {
...
//
//    public SSDMobileNetwork(String protoTxt, String model, String labelMapping) {
//        this.netThreadLocal = getNet(model, protoTxt);
//        this.labels = getLabels(labelMapping);
//    }
//
//    private static ThreadLocal<Net> getNet(String model, String protoTxt) {
//        Objects.requireNonNull(protoTxt, "protoTxt");
//        Objects.requireNonNull(model, "model");
//        return ThreadLocal.withInitial(() -> readNetFromCaffe(protoTxt, model));
//    }
//
...
//
//        Mat inputBlob = blobFromImage(frame, SCALE_FACTOR, SIZE, Scalar.all(127.5), false, false, CV_32F);
//        // set input
...
//        return ProcessedFrame.frame(rawFrame.getTimestamp(), postProcess(frame, outs));
//    }
//
